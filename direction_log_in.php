<?php 
header("Refresh:4;URL=http://exx/main.php");
?><!DOCTYPE html>
        ...
        <div class="container">
            <div class="col-md-12">
                <div class="registration">
                    <div class="row">
                        <div class="col-md-12">
                            <p>Вы успешно зарегестрировались! Сейчас вы будете перенаправлены на форму входа. <a href="http://exx/main.php">Нажмите,если этого не произошло</a></p>
                        </div>
                    </div>
                </div>
            </div>
